...
class ExecutionOutput:
    ...
    Attributes:
        ...
        iterations: 执行的迭代次数（启用反思时）
        progress_info: 最终的进度信息（ProgressInfo对象）
    """
    success: bool
    instruction: str
    ...
    iterations: int = 1
    progress_info: Optional[Any] = None  # ProgressInfo对象
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        # 如果有 progress_info，也包含进去
        if self.progress_info:
            result['progress_info'] = {
                'action_result': self.progress_info.action_result,
                'error_potential_causes': self.progress_info.error_potential_causes,
                'progress_status': self.progress_info.progress_status
            }
