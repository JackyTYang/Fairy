...
from Fairy.memory.short_time_memory_manager import MemoryType, MemoryCallType
        ...
        if len(self.task_list) == 0:
            ...
            match task_source:
                case "UserInteractorAgent":
                    ...
                    memory[MemoryCallType.GET_Key_Info].extend(previous_key_info)
                    # 更新父任务的KeyInfo
                    await self.publish("app_channel", EventMessage(EventType.KeyInfoExtraction, EventStatus.DONE, memory[MemoryCallType.GET_Key_Info]))
